        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="viewart.php">view Art</a></li>
              <!--../../pages/ui-features/buttons.html-->
                <li class="nav-item"> <a class="nav-link" href="addart.php">Add Art </a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="../../pages/forms/category.php">Category</a></li>
                <li class="nav-item"><a class="nav-link" href="../../pages/forms/subcategory.php">Sub Category</a></li>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="exampleInputName1">Art Name</label>
                   ...
                   <div class="form-group">
                     ...
                     <option value="<?php echo $row['catid'];?>"><?php echo ($row['c_name']); ?></option>
                     <?php }
                      ?>
                     </select>
                        </select>
                      ...
                      <label for="exampleSelectGender">Sub Category </label>
                        <select class="form-control" name="sid" id="sub_category">
